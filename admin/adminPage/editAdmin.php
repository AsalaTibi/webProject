        ...
        <div class="container-fluid">
          ...
          <div class="card-body">
            ...
            if($res->num_rows > 0){
              ...
              <input type="hidden" name="update_email" value="<?php echo $row['email']?>">
                 <div class="form-group">
                   <label>Password</label>
                   <input type="text" name="update_pass" value="<?php echo $row['password']?>" class="form-control" placeholder="Edit password">
                 </div>
