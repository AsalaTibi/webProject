        ...
        <div id="content">
                        ...
                        <form method="post" action="code.php" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="userType" class="form-control" value="admin" disabled>
                                </div>
                                <div class="form-group">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    $sql="select email,user_type,password from users";
                    $res=$db->query($sql);
                    ?>
                        ...
                        if($res->num_rows > 0){
                            while ($row=$res->fetch_assoc()){
                              ...
                              <tr>
                                ...
                                <td><button type="submit" class="btn btn-success" name="edit_admin">EDIT</button></td>
                                </form>

                                    <form action="code.php" method="post">
                                        <input type="hidden" name="delete_email" value="<?php echo $row['email']?>">
                                        <td><button type="submit" class="btn btn-danger" name="delete_admin">DELETE</button></td>
                                    </form>
                                </tr>
                                <?php
                                }
