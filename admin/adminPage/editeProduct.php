                    ...
                    <form action="code.php" method="post">
                      <input type="hidden" name="edit_id" value="<?php echo $row['id']?>">
                         ...
                         <div class="form-group">
                           ...
                           <input type="text" name="edit_Type" value="<?php echo $row['product_type']?>" class="form-control" placeholder="Enter Product Type">
                         </div>
                        ...
                        <div class="form-group">
                             <label>Product Image</label>
                              <input type="file" name="edit_image" value="<?php echo $row['product_image']?>" class="form-control" placeholder="Upload Image">
                        </div>
